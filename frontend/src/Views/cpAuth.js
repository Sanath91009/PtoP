...
export const CpAuth = () => {
    ...
    const HandleRegister = async (e) => {
        ...
        const endpoint = config.apiUrl + "/register/cf";
        try {
    ...
    const HandleLogin = async (e) => {
        ...
        const endpoint = config.apiUrl + "/login/cf";
        try {
            await fetch(endpoint, {
                method: "post",
                headers: {
                ...
                .then((data) => {
                    if (data.code == 200) {
                        ...
                        Login("codeforces", data.token.accessToken);
                        navigate("/dashboard", {
                            replace: true,
                            state: { section: section, username: username },
                        });
    ...
    return (
        <div>
            ...
            <div className="container">
                <p className="px-3">
                    Please make your email ID public before signing in for
                ...
                <div className="row">
                    ...
                    <div className="col">
                        <form className="px-3" onSubmit={HandleLogin}>
                            <div className="form-group mb-2">
                                <label for="username1">Handle</label>
                                <input
                                    type="text"
                                    className="form-control"
                                    id="username1"
